...
const NAVBAR_LINK_STYLE: &str = "p-1 px-4 justify-center grow flex text-white hover:border-transparent hover:bg-blue-2 border-2 border-blue-2 rounded-md transition ease-in-out delay-30";

#[allow(non_snake_case)]
#[inline_props]
pub fn Navigation(cx: Scope) -> Element {
    render! {
        nav { class: "mx-auto p-2 flex flex-wrap bg-blue-1 rounded-md gap-2",
